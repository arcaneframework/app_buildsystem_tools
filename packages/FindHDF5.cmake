...
# HDF5_LIBRARIES
#
# Target hdf5 and all targets included in hdf5 install config file
...
if(HDF5_FOUND AND NOT TARGET hdf5)
  ...
  find_package(HDF5) # create all needed targets for Arcane::find_dependency...
  ...
  set_target_properties(hdf5_main PROPERTIES
    ...
    IMPORTED_IMPLIB_LOCATION "${HDF5_LIBRARY}")
