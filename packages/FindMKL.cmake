...
if(WIN32)
# ================================================= #
# D�but : Recherche de mkl_def.dll ou mkl_def.1.dll #
# ================================================= #

# Liste des r�pertoires � tester
set(MKL_SEARCH_DIRS
    "${MKL_REDIST_ROOT}"
    "${MKL_REDIST_ROOT}/bin"
...
# Variable pour stocker le chemin trouv�
set(MKL_DLL_PATH "")

# Boucle sur les r�pertoires et les noms
