...
var path = this.Session["path"] as string; 
            ...
            #line 21 "XPathT4.tt"
            this.Write(" {\n\n  class XPath \n    : public Gump::IXPath\n  {\n  public:\n  \n    static Gump::En" +
                    "tity entity(Gump::Entity root, Arcane::String path)\n    {\n      return XPath(roo" +
                    "t).entity(path);\n    }\n    \n    static Arcane::SharedArray<Gump::Entity> entitie" +
                    "s(Gump::Entity root, Arcane::String path)\n    {\n      return XPath(root).entitie" +
                    "s(path);\n    }\n\n    static Gump::ScalarRealProperty scalarRealProperty(Gump::Ent" +
                    "ity root, Arcane::String path)\n    {\n      return Gump::ScalarRealProperty(XPath" +
                    "(root).property(path));\n    }\n\n    static Gump::Property property(Gump::Entity r" +
                    "oot, Arcane::String path)\n    {\n      return XPath(root).property(path);\n    }\n " +
                    "   \n    static Arcane::SharedArray<Gump::Property> properties(Gump::Entity root," +
                    " Arcane::String path)\n    {\n      return XPath(root).properties(path);\n    }\n   " +
                    " \n  public:\n    \n    XPath(Gump::Entity root)\n      : m_root(root) {} \n         " +
                    "             \n    Gump::Entity entity(Arcane::String path)\n    {\n      Gump::XPa" +
                    "th<Gump::Entity> xpath;\n      \n      EntityKindConverter entity_converter; \n    " +
                    "\n      return xpath(m_root, path, entity_converter);\n    }\n    \n    Arcane::Shar" +
                    "edArray<Gump::Entity> entities(Arcane::String path)\n    {\n      Gump::XPath<Gump" +
                    "::Entity> xpath;\n      \n      EntityKindConverter entity_converter; \n    \n      " +
                    "return xpath.pack(m_root, path, entity_converter);\n    }\n\n    Gump::Property pro" +
                    "perty(Arcane::String path)\n    {\n      Gump::XPath<Gump::Property> xpath;\n    \n " +
                    "     EntityKindConverter entity_converter; \n    \n      PropertyKindConverter pro" +
                    "perty_converter; \n    \n      return xpath(m_root, path, entity_converter, proper" +
                    "ty_converter);\n    }\n    \n    Arcane::SharedArray<Gump::Property> properties(Arc" +
                    "ane::String path)\n    {\n      Gump::XPath<Gump::Property> xpath;\n    \n      Enti" +
                    "tyKindConverter entity_converter; \n    \n      PropertyKindConverter property_con" +
                    "verter; \n    \n      return xpath.pack(m_root, path, entity_converter, property_c" +
                    "onverter);\n    }\n    \n  private:\n  \n    Gump::Entity m_root;\n  };\n\n}\n\n#endif /* " +
                    "");
